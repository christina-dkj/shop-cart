<template>
<div
class="mask" v-if="showCart && calculations.total>0"
...
export default {
  ...
  setup () {
    ...
    return { calculations, shopId, productList, changeCartItemInfo, changeCartItemChecked, cleanCartProducts, setCartItemsChecked, showCart, handleCartShowChange }
  }
}
</script>
